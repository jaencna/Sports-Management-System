...
<head>
    ...
    <!-- Page CSS and JS -->
    <link rel="stylesheet" href="../../cssFile/managePlayerBball.css">
...
<div id="loadingScreen" style="display: none;">
    ...
    <div style="margin-top:-59px; height: 70px; color: white; align-content: center;"> <img src="../../images/homepage/natakbo.png" style="padding-left: 18px;" height="40" > </div>
        ...
        <div class="teamManager" style="height: 33vh;">
            ...
            <a href="managePlayerBball.php" class="loading-link"><i class="fa-solid fa-users active"></i></i>Manage Players</a>
...
<!-- 
    ...
    <script src="../../jsFile/managePlayerBball.js"></script>
    <script>
